 ...
 * Fourteenth programming challenge for CSCI 21. Complete the definition of the
 * default constructor ShoppingList, and the functions getMaxItems, addItems,
 * string getItem, string& getItem, and removeItem to pass the unit tests.
