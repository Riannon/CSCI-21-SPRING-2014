 ...
 * Second programming challenge for CSCI 21. Complete the isFactor, makeChange,  
 * launchHumanCannonball functions to pass the unit tests. All sections labeled
 * with "CODE HERE" need to be filled in per instructions on assignment.
 *
 * Kevan Johnson
