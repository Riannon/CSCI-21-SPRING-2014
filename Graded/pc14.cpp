 ...
 * Fourteenth programming challenge for CSCI 21. Complete the definition for the
 * bubbleSort, selectionSort, and swapValues functions to pass the unit tests.
